...
class ScoreScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    scoreController _scoreController =
        Get.put(scoreController(result: result, questions: questions));
              ...
              child: Column(children: [
                ...
                Container(
                    decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                              color: _scoreController.progressSubColor
                                  .withOpacity(0.4),
                              blurRadius: 20,
                          ...
                          center: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Text(
                                      "${((_scoreController.time.value / questions.length) * 100).round()}",
                    ...
                    children: [
                      ...
                      Flexible(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) => categoryScoreWidget(
                              category: _scoreController.categories[index]),
                          itemCount: _scoreController.categories.length,
                        ),
                      )
                    ],
                  ),
                          ...
                          children: [
                            Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    gradient:
                                        _scoreController.messageBackground,
                                    boxShadow: [
...
class categoryScoreWidget extends StatelessWidget {
  static const List<Color> colors = [
    Color.fromARGB(255, 186, 25, 0),
    Color.fromARGB(255, 17, 200, 0),
    Color.fromARGB(255, 0, 47, 255),
    Color.fromARGB(255, 186, 25, 0),
    Color.fromARGB(255, 186, 25, 0)
  ];
  final Category category;
  const categoryScoreWidget({Key? key, required this.category})
      : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text("${category.questionCorrect}/${category.questionCount}",
                  style: Theme.of(context).textTheme.bodyText2?.copyWith(
                        color: Colors.black,
                        fontSize: 20.sp,
              ...
              Container(
                ...
                child: LinearPercentIndicator(
                  ...
                  progressColor: colors[category.id],
                  lineHeight: 10,
                  percent: category.questionCorrect / category.questionCount,
                  animation: true,
