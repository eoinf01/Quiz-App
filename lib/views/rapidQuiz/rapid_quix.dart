...
import 'package:theorytest/views/rapidQuiz/components/question_card.dart';
...
class rapidQuizScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    rapidQuestionController _controller = Get.put(rapidQuestionController());
    return Scaffold(
                      ...
                      Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Obx(()=> Text("${_controller.getMinutes.value.inSeconds.remainder(60)}s",
