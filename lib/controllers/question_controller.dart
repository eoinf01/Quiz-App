...
class QuestionController extends GetxController with GetSingleTickerProviderStateMixin{
  ...
  final Rx<Duration> time = Duration(seconds: 2700).obs;
  ...
  void onInit() {
    ...
    _animationController = AnimationController(vsync: this,duration: Duration(seconds: 2700));

    _animation = StepTween(begin: 2700,end: 0).animate(_animationController)..addListener(() {
